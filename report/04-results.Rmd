...
The proportion of ODT requests that were fulfilled also does not vary much between the scenarios. Notably, though, the values in the "Existing" and "D" scenarios are somewhat higher than the rest.
